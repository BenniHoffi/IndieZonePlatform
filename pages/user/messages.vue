<template>
    <div class="flex justify-center gap-8 text-primary">
        <div class="h-full w-1/4" />
        <div class="flex h-full w-1/2 flex-col items-center gap-8">
            ...
            <div class="flex w-full gap-4 rounded-xl bg-user-surface-container p-4">
                <span class="p-float-label">
                    <Textarea id="nachricht" rows="3" cols="44" />
                    <label for="nachricht">Deine Nachricht</label>
                </span>
                <Button class="text-user-surface-bright h-10 bg-primary" size="small">
                    <div class="flex items-center gap-2">
                        <Icon name="material-symbols:send" />
                        <p class="text-label-large">Senden</p>
                    </div>
                </Button>
            </div>
        </div>
        <div class="flex h-full w-1/4 flex-col rounded-l-xl bg-surface-bright p-4">
