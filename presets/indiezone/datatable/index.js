export default {
    ...
    column: {
        headercell: ({ context, props }) => ({
            class: [
                ...
                (props.sortable === "" || props.sortable) && context.sorted
                    ? "dark:text-primary dark:bg-primary-400/30"
                    : "dark:text-primary/80 dark:bg-surface-800",
                "border-surface-200 dark:border-surface-700 ",
        ...
        sort: ({ context }) => ({
            class: [
                ...
                context.sorted ? "dark:text-primary-400" : "dark:text-primary/80",
            ],
        }),
        ...
        footercell: ({ context }) => ({
            class: [
                ...
                // Color
                "border-surface-200 dark:border-surface-700",
                "text-surface-700 dark:text-primary/80",
                "bg-surface-50 dark:bg-surface-800",
            ],
        }),
        sorticon: ({ context }) => ({
            class: ["ml-2", context.sorted ? "text-primary-700 dark:text-primary/80" : "text-surface-700 dark:text-primary/70"],
        }),
        sortbadge: {
            class: [
                // Flex & Alignment
        ...
        filteroverlay: {
            class: [
                ...
                "text-surface-800 dark:text-primary/80",
        ...
        filterrowitem: ({ context }) => ({
            class: [
                ...
                // Color
                { "text-surface-700 dark:text-primary/80": !context?.highlighted },
                { "bg-surface-0 dark:bg-surface-800 text-surface-700 dark:text-primary/80": !context?.highlighted },
                { "bg-primary-100 dark:bg-primary-400/40 text-primary-700 dark:text-primary/80": context?.highlighted },
                { "bg-primary-50 dark:bg-primary-400/40 text-primary-700 dark:text-primary/80": context?.highlighted },

                //States
                { "hover:bg-surface-100 dark:hover:bg-surface-600/80": !context?.highlighted },
                {
                    "hover:text-surface-700 hover:bg-surface-100 dark:hover:text-primary dark:hover:bg-surface-600/80":
                        !context?.highlighted,
                },
                "focus-visible:outline-none focus-visible:outline-offset-0 focus-visible:ring focus-visible:ring-inset focus-visible:ring-primary-400/50 dark:focus-visible:ring-primary-300/50",
        ...
        filteroperatordropdown: {
            ...
            input: ({ props }) => ({
                class: [
                    ...
                    "border-0",
                    {
                        "text-surface-800 dark:text-primary/80": props.modelValue,
            ...
            item: ({ context }) => ({
                class: [
                    ...
                    // Color
                    { "text-surface-700 dark:text-primary/80": !context.focused && !context.selected },
                    {
                        "bg-surface-50 dark:bg-surface-600/60 text-surface-700 dark:text-primary/80":
                            context.focused && !context.selected,
                    },
                    {
                        "bg-primary-100 dark:bg-primary-400/40 text-primary-700 dark:text-primary/80":
                            context.focused && context.selected,
                    },
                    {
                        "bg-primary-50 dark:bg-primary-400/40 text-primary-700 dark:text-primary/80":
                            !context.focused && context.selected,
                    },
        ...
        filterapplybutton: {
            root: {
                class: [
                    ...
                    "text-primary dark:text-surface-900",
        ...
        filtermenubutton: ({ context }) => ({
            class: [
                ...
                "dark:text-primary/70 dark:hover:text-primary/80 dark:bg-surface-800",
        ...
        rowtoggler: {
            class: [
                ...
                // Color
                "text-surface-500 dark:text-primary/70",
                "bg-transparent",
        ...
        roweditorinitbutton: {
            class: [
                ...
                // Color
                "text-surface-700 dark:text-primary/70",
                "border-transparent",
        ...
        rowRadiobutton: {
            ...
            box: ({ props }) => ({
                class: [
                    ...
                    // Colors
                    {
                        "text-surface-700 dark:text-primary/80": !props.modelValue,
    ...
    rowexpansion: {
        class: "bg-surface-0 dark:bg-surface-800 text-surface-600 dark:text-primary/80",
    },
    rowgroupheader: {
        class: ["sticky z-20", "bg-surface-0 text-surface-600 dark:text-primary/70", "dark:bg-surface-800"],
    },
    rowgroupfooter: {
        class: ["sticky z-20", "bg-surface-0 text-surface-600 dark:text-primary/70", "dark:bg-surface-800"],
    },
